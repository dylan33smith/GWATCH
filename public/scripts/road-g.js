...
Road.prototype.regenerateRoad = function (gl, columnData) {
    ...
    vertsFloatArray.addData3(left, -0.01, roadStart);
    vertsFloatArray.addData3(0.3, 0.3, 0.3);

    vertsFloatArray.addData3(left, -0.01, roadEnd);
    vertsFloatArray.addData3(0.3, 0.3, 0.3);

    vertsFloatArray.addData3(right, -0.01, roadEnd);
    vertsFloatArray.addData3(0.3, 0.3, 0.3);

    vertsFloatArray.addData3(right, -0.01, roadStart);
    vertsFloatArray.addData3(0.3, 0.3, 0.3);
    ...
    vertsFloatArray.addData3(left, 0, 0.5);
    vertsFloatArray.addData3(1.0, 1.0, 1.0);

    vertsFloatArray.addData3(left, 0, -0.5);
    vertsFloatArray.addData3(1.0, 1.0, 1.0);

    vertsFloatArray.addData3(right, 0, -0.5);
    vertsFloatArray.addData3(1.0, 1.0, 1.0);
